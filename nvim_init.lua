...
-- Reduce LSP logging to improve performance
...
-- Split creation and navigation with leader+s
vim.keymap.set("n", "<leader>sh", "<cmd>split<cr>", { desc = "Split horizontal" })
vim.keymap.set("n", "<leader>sl", "<cmd>vsplit<cr>", { desc = "Split vertical (left)" })
vim.keymap.set("n", "<leader>sj", "<cmd>split<cr><C-w>j", { desc = "Split horizontal and go down" })
vim.keymap.set("n", "<leader>sk", "<cmd>split<cr><C-w>k", { desc = "Split horizontal and go up" })
vim.keymap.set("n", "<leader>si", "<cmd>vsplit<cr><C-w>l", { desc = "Split vertical and go right" })
vim.keymap.set("n", "<leader>sd", "<cmd>split<cr><C-w>h", { desc = "Split vertical and go left" })
